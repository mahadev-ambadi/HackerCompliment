...
function LoginContent() {
  ...
  return (
    <div 
      className="relative flex h-screen overflow-hidden flex-col items-center justify-center px-4 pt-0 pb-8 bg-cover bg-center bg-no-repeat bg-fixed text-white font-sans selection:bg-[#FF6B2B]/30"
    ...
    >
      ...
      <div className="relative w-full max-w-md mt-16 sm:mt-0">
        ...
        <div className="rounded-2xl border border-zinc-700 bg-black/70 p-6 sm:p-8 shadow-2xl backdrop-blur-lg">
          <h1 className="text-2xl font-bold text-white drop-shadow-md">Welcome Back</h1>
      ...
      <div className="relative flex justify-center text-xs uppercase tracking-wide">
        <span className="bg-zinc-900/80 px-3 text-zinc-500">or continue with email</span>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="flex justify-end">
              <Link href="/forgot-password" className="text-sm text-[#FF6B2B] transition-colors hover:text-[#FF6B2B]">
                Forgot Password?
              </Link>
            </div>
        ...
        <p className="mt-4 text-center text-sm text-zinc-300 drop-shadow-sm bg-black/60 backdrop-blur-md px-4 py-2 rounded-xl border border-zinc-700/50 w-fit mx-auto shadow-xl">
          ...
          <Link href="/signup" className="font-bold text-[#FF6B2B] hover:text-[#FF6B2B] transition-colors">
            Sign Up
          </Link>
        </p>
      </div>
