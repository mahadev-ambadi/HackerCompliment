      ...
      <main className="h-[calc(100vh-4rem)]">
        ...
        {step === "setup" && (
          <div className="mx-auto max-w-2xl px-6 py-12">
            <div className="mb-8">
              <h1 className="text-3xl font-bold text-white">Setup Practice Session</h1>
              <p className="mt-2 text-zinc-400">Choose a company, difficulty, and your preferred language.</p>
            </div>

            <div className="space-y-6 rounded-2xl border border-zinc-800 bg-zinc-900/50 p-8 shadow-xl">
              <div className="space-y-3" ref={dropdownRef}>
                <label className="text-sm font-semibold text-zinc-300">Target Company</label>
